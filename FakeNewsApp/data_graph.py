...
# ==================  NODE FREQUECY ====================================================
  ...
  # ================== WORDCLOUD =========================================================
    ...
    def plot_wordcloud(self, tail_number=25, ascending=True, save=False, save_as='word_cloud.png', html=False, html_name='word_cloud.html', mask_png=None, pad=0, width=400, height=200, fig_size=[10,10], background_color="white", max_words=1000, interpolation = 'bilinear', **kwargs):
